...
def clasificationMetrics(real,predictions,*,threshold=0.5, class1='Class1', class2='Class2', cmap='viridis'):
    ...
    g = sn.heatmap(confusionMatrix, annot=True, fmt='.5g', cmap=cmap, 
                   annot_kws={"fontsize":20}, cbar=False)
    g.set_xticklabels([f'{class1} (1)',f'{class2} (0)'],fontdict={'size':18})
    g.set_yticklabels([f'{class1} (1)',f'{class2} (0)'],fontdict={'size':18})
