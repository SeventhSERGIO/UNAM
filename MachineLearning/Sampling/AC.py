...
def createBinaryHist(X, *, ax, color=(101/255,110/255,242/255), alpha=1):
    ax.hist(X, bins=2, rwidth=0.9, align='left', color= color, 
            density=True, range=(X.min(), X.max()+1), alpha=alpha);
    return ax